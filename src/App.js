  ...
  return (
    <div style={{'backgroundColor': '#FFFFFF'}}>
      <Grid container spacing={0}>
        ...
        <Grid item md={5} sm={12} xs={12} className='shunIntro' style={{'backgroundColor': '#856d72', 'margin': '10px 0'}}>
          <p style={{ fontSize: 22, textIndent: '2em', color: 'rgb(220, 220, 220)', 'lineHeight': 1.8, 'paddingRight': '40px', 'paddingLeft': '40px', 'paddingTop': '20%', 'marginTop': '10px', 'textAlign': 'justify'}}>
          ...
          <p style={{ fontSize: 20, textIndent: "2em", color: "rgb(220, 220, 220)", textAlign: "right", 'paddingRight': '40px' }}>
            ——垣曲舜文化研究会会长 李道义
          </p>
        </Grid>
        <Grid item md={5} sm={12} xs={12} style={{'margin': '10px 0'}}>
